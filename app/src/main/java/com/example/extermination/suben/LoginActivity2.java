...
import com.example.extermination.suben.Helper.SQLiteHandler;
...
public class LoginActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            ...
            Intent intent = new Intent(LoginActivity2.this, SelectorRuta.class);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(name, email, uid, created_at, id);
